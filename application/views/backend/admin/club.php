...
<?php echo form_open('admin/club/insert', array('class' => 'form-horizontal form-goups-bordered validate'));?>
        ...
        <tbody>
          ...
          <?php $count = 1; foreach ($select_club as $key => $club): ?>
            <tr>
                  ...
                  <a href="<?php echo site_url();?>admin/club/delete/<?php echo $club['club_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                </td>
              </tr>
                    <?php endforeach;?>
                    </tbody>
