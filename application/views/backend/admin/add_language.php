<div class="row">
    <div class="col-sm-12">
              ...
              <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('add language'); ?></div>
                <?php echo form_open('admin/manage_language/add_language', array('class' => 'form-horizontal form-goups-bordered validate'));?>
					<div class="panel-body table-responsive">
					<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('name language');?></label>
                    <div class="col-sm-12">
