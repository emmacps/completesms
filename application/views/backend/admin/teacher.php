  ...
  <div class="row">
                    ...
                    <div class="col-sm-12">
                            <select name="" class="form-control select2" style="width:100%" required>
        ...
        <input class="form-control m-r-10" name="birthday" type="date" value="2018-08-19" id="example-date-input" required>
                    ...
                    <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                       <select class=" form-control select2" name="marital_status" style="width:100%" required>
                                        ...
                                        <option data-tokens=""><?php echo get_phrase('married');?></option>
                                        <option data-tokens=""><?php echo get_phrase('single');?></option>
                                        <option data-tokens=""><?php echo get_phrase('divorced');?></option>
                                        <option data-tokens=""><?php echo get_phrase('engaged');?></option>
                                    </select>
                                    </div>
                                </div>
              ...
              <p style="color:red">Accept zip, pdf, word, excel, rar and others</p>
                    ...
                    <div class="col-sm-12">
                        <input type="password" class="form-control" name="" value="password" onkeyup="CheckPasswordStrength(this.value)" required>
                    ...
                    <div class="form-group"> 
                     ...
                     <div class="col-sm-12">
                      <input type='file' name="file" class="dropify" onChange="readURL(this);" / required>
...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <select name="" class="form-control select2" id="designation_holder">
...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <select name="status" class="form-control select2">
            <option value=""><?php echo get_phrase('active'); ?></option>
            <option value=""><?php echo get_phrase('inactive'); ?></option>
        </select>
    </div> 
</div>
<div class="form-group">
...
<a href="<?php echo base_url();?>admin/editTeacher/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></button></a>
                            
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/teacher/delete/');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>


<a href="<?php echo base_url().'uploads/teacher_image/'; ?>"><button type="button" class="btn btn-warning btn-circle btn-xs"><i class="fa fa-download"></i></button></a>

<a href="<?php echo base_url();?>admin/teacher_profile/"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-link"></i></button></a>
                            </td>
                        </tr>
        ...
        if(department_id != '')
            $.ajax((
                ...
                success: function(response){
                    ...
                    iQuery('#designation_holder').html(response);
                }
                ));
        else
