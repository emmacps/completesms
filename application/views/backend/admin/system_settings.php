        ...
        <div class="panel panel-info">
            ...
            <?php echo form_open(base_url(). 'systemsetting/system_settings/do_update', array('class' => 'form-horizontal form-groups-bordered', 'enctype'=> 'multipart/form-data'));?>
                    <div class="form-group">
                        <label class="col-md-12" for=""><?php echo get_phrase('System name'); ?></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for=""><?php echo get_phrase('System title'); ?></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for=""><?php echo get_phrase('Address'); ?></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for=""><?php echo get_phrase('System Email'); ?></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for=""><?php echo get_phrase('text_align'); ?></label>
                        <div class="col-sm-12">
